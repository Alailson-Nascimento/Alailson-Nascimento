...
Sou um estudante apaixonado por tecnologia, com formação em **Análise e Desenvolvimento de Sistemas** e atualmente cursando **Bacharelado em Sistemas de Informação** na Gran Faculdade.

Tenho experiência prática em desenvolvimento e manutenção de websites com **WordPress**, **HTML**, **CSS** e **JavaScript**, além de conhecimentos em automação com **n8n** e versionamento com **Git/GitHub**. Busco oportunidades de estágio e vagas iniciais em TI para desenvolver experiência profissional e contribuir com projetos reais.

- 🎓 **Formação:** Tecnólogo em ADS (Concluído) | Bacharel em SI (2024–2028)
- 💼 **Experiência:** Estagiário Voluntário em TI na Universo Drop
- 🌱 **Aprendendo:** Business Intelligence, Full Stack Development, Automação
...
|---------|-----------|-------------|
| [**DevLinks**](https://github.com/Alailson-Nascimento/devlinks) | Projeto final da trilha Discover da Rocketseat | HTML, CSS |
| [**Amigo Secreto**](https://github.com/Alailson-Nascimento/amigo-secreto) | App para sorteio de amigo secreto | JavaScript, HTML, CSS |
